<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookApp.aspx.cs" Inherits="NewClinic.BookApp" %>
                            ...
                            <div class="row g-3">
                              <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    ...
                                    <select class="form-select bg-white border-0" style="height: 55px;" id="clinic" runat="server">
                                        
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <select class="form-select bg-white border-0" style="height: 55px;" runat="server" id="doctor">
                                       
                                    </select>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="text" class="form-control bg-white border-0" placeholder="Your Name" style="height: 55px;" runat="server" id="name">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="email" class="form-control bg-white border-0" placeholder="Your Email" style="height: 55px;" runat="server" id="email">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <div class="date" data-target-input="nearest">
                                        <input type="date"
                                            class="form-control bg-white border-0 datetimepicker-input"
                                            placeholder="Date" data-target="#date" data-toggle="datetimepicker" style="height: 55px;" runat="server" id="date">
                                    </div>
                                </div>
                                  <div class="col-12 col-sm-6">
                                    <select class="form-select bg-white border-0" style="height: 55px;" runat="server" id="time">
                                ...
                                <div class="col-12">
                                    <asp:Button class="btn btn-primary w-100 py-3" type="submit" onclick="savedata" ID="cnbtn" runat="server" Text="Make An Appointment" />
